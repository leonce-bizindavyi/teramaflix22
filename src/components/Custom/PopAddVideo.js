  ...
  return (
    <>
      <div onDrop={handleDrop}
        onDragOver={handleDragOver} className="popup-drop-video absolute md:right-8 right-0 top-5 flex flex-col justify-center items-center  bg-blue-500 md:shadow-md md:w-[500px] w-full h-[300px] rounded-md">
