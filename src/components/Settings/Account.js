   ...
   const updated = () =>{
    ...
    useEffect(() => {
      ...
      const handleSubmit = async (event)=>{
        ...
        return (
          <>
              <form  className="ml-0 px-5 sm:ml-[14rem] -mt-[1.5rem] sm:mt-[4.5rem] lg:mt-[1rem] lg:mb-3 " onSubmit={handleSubmit} id="containerAccount">
                  <div  className="relative shadow-blue-500 shadow-lg  rounded-md mb-[3rem] sm:mb-[4rem] lg:mb-[0.8rem] ring-1 ring-blue-600/50 sm:w-[20rem] lg:w-[28rem] h-[33rem]  sm:mx-auto  lg:ml-[19rem]">
                      <div  className="grid grid-cols-1 gap-y-[2rem]  place-items-center  ">
                          ...
                          <div  className="mt-[2rem]  flex  justify-center">
                              <div className='relative'>
                                  ...
                                  <input type="text" value={nom} id='first name and last name' name="nom" onChange={(e)=>setNom(e.target.value)} className="mt-1 shadow-blue-500 font-serif  text-center shadow-md rounded-lg focus:outline-blue-600 focus:placeholder-gray-400 text-gray-600 placeholder-gray-400 pl-2 bg-gray-100 dark:bg-gray-800 py-2 -pr-5 w-[14rem] sm:w-72 md:w-48 xl:w-60 "/>
                          ...
                          <div className="  flex  justify-center">
                            <div className="relative">
                              ...
                              <input type={ statusPass?"text":"password" } placeholder="password" name="password" id='password' value={password} onChange={(e)=>setPassword(e.target.value)} className="shadow-blue-500 font-serif mt-1  text-center shadow-md rounded-lg focus:outline-blue-600 focus:placeholder-gray-400 text-gray-600 placeholder-gray-400 pl-2 bg-gray-100 dark:bg-gray-800 py-2 -pr-5 w-[14rem] sm:w-72 md:w-48 xl:w-60 "/>
                          ...
                          <div className="  flex  justify-center   ">
                            <div className="relative">
                              ...
                              <input type={statusCpass?"text":"password"} name="cpassword" id='confirm password' value={cpassword} placeholder="confirm password" onChange={(e)=>setCpassword(e.target.value)} className="shadow-blue-500 font-serif mt-1  text-center shadow-md rounded-lg focus:outline-blue-600 focus:placeholder-gray-400 text-gray-600 placeholder-gray-400 pl-2 bg-gray-100 dark:bg-gray-800 py-2 -pr-5 w-[14rem] sm:w-72 md:w-48 xl:w-60 "/>
                          ...
                          <div className="  flex  justify-center   ">
                            <div className="relative">
                              ...
                              <input type="mail" name="mail" value={mail} id='email' onChange={(e)=>setMail(e.target.value)}  className="shadow-blue-500 font-serif mt-1  text-center shadow-md rounded-lg focus:outline-blue-600 focus:placeholder-gray-400 text-gray-600 placeholder-gray-400 pl-2 bg-gray-100 dark:bg-gray-800 py-2 -pr-5 w-[14rem] sm:w-72 md:w-48 xl:w-60 "/>
