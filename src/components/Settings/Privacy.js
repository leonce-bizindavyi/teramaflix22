...
function Privacy() {
  return (
    <>
      <div className="ml-0 sm:ml-64  px-4 md:px-10 lg:px-0 " id="containerAccount">
        <div className="p-6 sm:px-10 md:px-0 2xl:px-6 xl:px-2 lg:px-0 shadow-blue-500 shadow-lg bg-white md:-ml-8 lg:ml-14 xl:ml-32 ml-0 lg:w-2/3 w-full rounded-md -mt-6 mb-4 sm:mb-6 sm:mt-[1rem] md:mt-4 md:mb-4 lg:mt-[1.4rem] lg:mb-4 ring-1 ring-blue-600/50">
