...
function Notify() {
  ...
  return (
    <>
       <div  className="w-full pr-[18rem] mb-[2rem] mt-[13.5rem] sm:ml-64 sm:mt-[20rem] sm:mb-[8.5rem] " id="containernotifications">{/* <!--debut contenu notifications--> */}       
            <div   className="space-y-8 w-72 ml-[50%]   shadow-blue-500 shadow-lg bg-white sm:ml-[2rem] md:ml-[6rem] xl:ml-80 xl:w-96 2xl:ml-96 mr-96 py-5 rounded-md -mt-[15rem] sm:-mt-[18rem] md:-mt-[17.5rem] lg:-mt-[19rem] pt-96 ring-1 ring-blue-500 lg:right-36">
